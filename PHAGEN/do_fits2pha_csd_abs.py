...
def main():
    ...
    csds_ab    =hdus[1].data['CSDA']
    dcsds_ab   =hdus[1].data['DCSDA']
    hdus.close()
    ...
    csds_ab    =csds_ab    [i_f_min:i_f_max]
    dcsds_ab   =dcsds_ab   [i_f_min:i_f_max]
    ...
    for ch_rebin_min, ch_rebin_max, csd_ab, dcsd_ab, df_rebin\
    in zip(chs_rebin_min, chs_rebin_max, csds_ab, dcsds_ab, dfs_rebin):
        rates[ch_rebin_min]=csd_ab*df_rebin 
        stats_err[ch_rebin_min]=dcsd_ab*df_rebin
