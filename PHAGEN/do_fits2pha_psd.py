...
def main():
    ...
    psds       =psds       [i_f_min:i_f_max]
    dpsds      =dpsds      [i_f_min:i_f_max]
    ...
    for ch_rebin_min, ch_rebin_max, psd, dpsd, df_rebin\
    in zip(chs_rebin_min, chs_rebin_max, psds, dpsds, dfs_rebin):
        rates[ch_rebin_min]=psd*df_rebin 
        stats_err[ch_rebin_min]=dpsd*df_rebin
