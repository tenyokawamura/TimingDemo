...
def main():
    ...
    hdu_ebo.header['TELESCOP']='HXMT'
    hdu_ebo.header['INSTRUME']='HXMT'
    ...
    hdu_mat.header['TELESCOP']='PREFLOW'
    hdu_mat.header['INSTRUME']='PREFLOW'
    ...
    hdus.writeto(name_outrmf, overwrite=True)
