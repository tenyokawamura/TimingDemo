...
def main():
    ...
    csds_im    =hdus[1].data['CSDI']
    dcsds_im   =hdus[1].data['DCSDI']
    hdus.close()
    ...
    csds_im    =csds_im    [i_f_min:i_f_max]
    dcsds_im   =dcsds_im   [i_f_min:i_f_max]
    ...
    for ch_rebin_min, ch_rebin_max, csd_im, dcsd_im, df_rebin\
    in zip(chs_rebin_min, chs_rebin_max, csds_im, dcsds_im, dfs_rebin):
        rates[ch_rebin_min]=csd_im*df_rebin 
        stats_err[ch_rebin_min]=dcsd_im*df_rebin
